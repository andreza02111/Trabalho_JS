...
function CadastroProduto({ adicionarProduto, produtoEditando, editarProduto, setTelaAdmin }) {
  ...
  return (
    <div className= 'cadastro-produto'>
      ...
      <button className='btn-admin' onClick={handleAdicionarProduto}>
        {produtoEditando ? "Atualizar Produto" : "Adicionar Produto"}
      </button>
      <button className='btn-admin' onClick={() => setTelaAdmin('dashboard')}>Voltar</button>
    </div>
  );
}
...
function AdminDashboard({ setTelaAdmin }) {
  return (
    <div className="admin-dashboard">
      ...
      <button className="btn-admin" onClick={() => setTelaAdmin('cadastrarAdmin')}>Cadastrar Admin</button> {/* Novo botão */}
    </div>
  );
}
...
function App() {
  ...
  const renderizarConteudo = () => {
    if (clienteLogado) {
      return (
        <div>
          <button className='btn-admin-logout' onClick={logoutCliente}>Logout Cliente</button>
          {endereco && (
            <div>
      ...
      return (
        <div>
          <button className='btn-admin-logout' onClick={logoutAdmin}>Logout Admin</button>
