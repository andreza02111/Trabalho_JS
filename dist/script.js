...
function CadastroProduto({ adicionarProduto, produtoEditando, editarProduto, setTelaAdmin }) {
  ...
  return /*#__PURE__*/(
    React.createElement("div", { className: "cadastro-produto" }, /*#__PURE__*/
    ...
    React.createElement("button", { className: "btn-admin", onClick: handleAdicionarProduto },
    produtoEditando ? "Atualizar Produto" : "Adicionar Produto"), /*#__PURE__*/

    React.createElement("button", { className: "btn-admin", onClick: () => setTelaAdmin('dashboard') }, "Voltar")));
...
function CadastroAdmin({ setShowCadastroAdmin, setAdmins, admins, setTelaAdmin }) {
  ...
  const handleCadastro = () => {
    ...
    alert(`Administrador cadastrado: ${nome}, ${email}`);
    setNome("");
    setEmail("");
    setSenha("");
    setTelaAdmin('dashboard');
...
function AdminDashboard({ setTelaAdmin }) {
  return /*#__PURE__*/(
    ...
    React.createElement("button", { className: "btn-admin", onClick: () => setTelaAdmin('verProdutos') }, "Ver Produtos"), /*#__PURE__*/
    React.createElement("button", { className: "btn-admin", onClick: () => setTelaAdmin('cadastrarAdmin') }, "Cadastrar Admin"), " "));
  ...
  const renderizarConteudo = () => {
    if (clienteLogado) {
      return /*#__PURE__*/(
        ...
        React.createElement("button", { className: "btn-admin-logout", onClick: logoutCliente }, "Logout Cliente"),
        endereco && /*#__PURE__*/
        React.createElement("div", null, /*#__PURE__*/
        React.createElement("p", null, "Endere\xE7o: ", endereco.logradouro, ", ", endereco.bairro), /*#__PURE__*/
        React.createElement("p", null, "Cidade: ", endereco.localidade, " - ", endereco.uf))));
      ...
      return /*#__PURE__*/(
        React.createElement("div", null, /*#__PURE__*/
        React.createElement("button", { className: "btn-admin-logout", onClick: logoutAdmin }, "Logout Admin"), /*#__PURE__*/
