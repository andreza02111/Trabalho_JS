  ...
  endereco })
{
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("p", null, "Adicione mais ", formatarPreco(valorParaFreteGratis), " para ganhar frete gr\xE1tis."), /*#__PURE__*/
...
function CadastroAdmin({ setShowCadastroAdmin, setAdmins, admins, setTelaAdmin }) {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("input", { type: "email", value: email, onChange: e => setEmail(e.target.value), placeholder: "Email" }), /*#__PURE__*/
    React.createElement("input", { type: "password", value: senha, onChange: e => setSenha(e.target.value), placeholder: "Senha" }), /*#__PURE__*/
    React.createElement("button", { className: "btn-admin", onClick: handleCadastro }, "Cadastrar"), /*#__PURE__*/
    React.createElement("button", { className: "btn-admin", onClick: () => setTelaAdmin('dashboard'), className: "botao-voltar" }, "Voltar")));
